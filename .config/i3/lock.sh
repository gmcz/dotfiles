...
#     do
#       convert /tmp/head_${i}.png -paint 1 -gaussian-blur 100 ~/.config/i3/lock.png -composite -matte /tmp/head_${i}.png;
#     done
# }
...
# Lock it up!
i3lock -e -f -c 000000 -i /home/greg/.config/nestled_jwy80.jpg
